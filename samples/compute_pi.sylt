...
let binary_split(a b) = do
    ...
    if b is a + 1: do
        ...
        let pam = List.get(0 split1)
        let qam = List.get(1 split1)
        let ram = List.get(2 split1)

        let split2 = binary_split(m b)
        let pmb = List.get(0 split2)
        let qmb = List.get(1 split2)
        let rmb = List.get(2 split2)
